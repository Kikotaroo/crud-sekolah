...
<div class="container mt-5">
    <h2 class="text-center mb-4">Manajemen Data Kelas</h2>
    <div class="row mb-3">
        <div class="col-md-6">
    ...
    <table class="table table-bordered table-striped">
        ...
        <tbody>
            ...
            if (!empty($search_query)) {
                $sql .= " WHERE kelas.nama_kelas LIKE '%$search_query%'";
            }
            ...
            if (mysqli_num_rows($result) > 0) {
                while ($row = mysqli_fetch_assoc($result)) {
                    echo "<tr>
                        ...
                        <td>
                            <button class='btn btn-warning btn-sm' data-bs-toggle='modal' data-bs-target='#editModal' data-id='{$row['id']}' data-nama='{$row['nama_kelas']}'>Edit</button>
                            <button class='btn btn-danger btn-sm' data-bs-toggle='modal' data-bs-target='#deleteModal' data-id='{$row['id']}' data-nama='{$row['nama_kelas']}'>Hapus</button>
                        </td>
                    </tr>";
                }
            } else {
